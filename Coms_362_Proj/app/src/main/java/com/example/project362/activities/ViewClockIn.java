...
public class ViewClockIn extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        findViewById(R.id.floatingActionButtonEdit).setOnClickListener(ViewClockIn.this);
        ...
        Shift.getShifts().addOnCompleteListener((Task<QuerySnapshot> task) -> {
            if (task.isSuccessful())
            {
                ...
                recyclerView.setAdapter(new ShiftsAdapterClockIn(shifts));
            }
            else
                Toast.makeText(ViewClockIn.this, "No Shifts At This Time!",
